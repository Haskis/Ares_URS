...
void ModbusServer::disconnected(){
  disconnect(mySocket, SIGNAL(readyRead()), this, SLOT(readDataAndRespond()));
  disconnect(mySocket, SIGNAL(disconnected()), this, SLOT(disconnected()));
